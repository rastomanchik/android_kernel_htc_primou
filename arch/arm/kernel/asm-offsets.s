...
@ -mlittle-endian -mno-unaligned-access -marm -mcpu=cortex-a8
@ -mtune=cortex-a8 -mfpu=neon -marm -mapcs -mno-sched-prolog
@ -mabi=aapcs-linux -mno-thumb-interwork -march=armv7-a -mfloat-abi=soft
@ -mtune=cortex-a8 -march=armv7-a -mfpu=neon -mvectorize-with-neon-quad
@ -mtls-dialect=gnu -auxbase-strip arch/arm/kernel/asm-offsets.s -Os
...
@ -fipa-cp-clone -fmodulo-sched -fmodulo-sched-allow-regmoves
@ -funsafe-math-optimizations -fgcse-after-reload -fno-dwarf2-cfi-asm
@ -fno-stack-protector -fno-omit-frame-pointer -fno-optimize-sibling-calls
@ -fno-strict-overflow -fconserve-stack -fno-aggressive-loop-optimizations
@ -fgcse-lm -fgcse-sm -fsched-spec-load -ffast-math
