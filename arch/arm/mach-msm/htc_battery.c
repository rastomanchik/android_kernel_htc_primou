...
/* rpc related */
#if (defined(CONFIG_MACH_PRIMODD)||defined(CONFIG_MACH_PRIMODS)||defined(CONFIG_MACH_GOLFU)||defined(CONFIG_MACH_MECHA))
...
/**
 * _htc_power_policy - check if it obeys our policy
